...
describe("hardened release contract", () => {
  ...
  test("freezes identity and non-production eligibility", () => {
    ...
    expect(RELEASE).toEqual({
      sourceCommit: "58d5ae38b582156627e13543cffc58ec4150d4b9",
      sourceTree: "48a34d8a65dd3cefb2834712dc56d800275e5b3b",
      packagesTree: "61ca5eda3f50665ef6080a575da37e53a6c9daed",
      artifactTree: "d61e3dfc0b0f1c1f7a1e9f396fe27a339264e588",
      baseCommit: "3104c1428ec91f809e5ab86631300de41eb6952e",
      patchSha256: "fdacf487136d269f6de16112e943d71d5c75c3dd1111eeb07d90e8442b59a44b",
  ...
  test("freezes an exact packages-only source patch", async () => {
    ...
    expect(bytes.byteLength).toBe(980383)
  ...
  test("keeps schema identity constants synchronized with RELEASE", async () => {
    ...
    expect(schema.properties.release.properties.patchSize.const).toBe(980383)
  ...
  test("enforces the manifest schema and rejects malformed assets", async () => {
    ...
    const value = {
      schemaVersion: 1,
      release: { ...RELEASE, patchSize: 980383 },
      workflow: {
        repository: "local",
        workflow: "local",
        runId: "local",
